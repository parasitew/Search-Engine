...
public class TermVector {
    ...
    public TermVector(int docId, String fieldName) throws IOException {
        ...
        this.stemMap = new HashMap<String, Integer>();
    ...
    public int getStemIdx(String stem) {
        if (this.stemMap.containsKey(stem)) {
